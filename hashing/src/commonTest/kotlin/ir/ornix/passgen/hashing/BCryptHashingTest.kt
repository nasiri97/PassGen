...
class BCryptHashingTest {
    ...
    companion object {
        ...
        private const val BCRYPT2 = $$"$2a$12$OuhtjoyMftLacTmVaeWDXOEmLve0j.AXy74JiSBFzVjpov6SCkJlK"
        ...
        private const val BCRYPT3 = $$"$2a$12$JNHLsj8umu2k4BqovZlgleaWoo2BxGM0sAUbeJTsGdDCs24koovhq"
        ...
        private const val BCRYPT4 = $$"$2a$12$nXEkz.tyGC/I.Paxx5cvi.OqWhN04gD3je48K05tPyPNL4w8snY0O"
        ...
        private const val BCRYPT5 = $$"$2a$12$5JqmxBWlYDQ9V1DRsbVpZ.ZfzKAflHfPHl/03amXA.WAKGxBUQMRC"
    ...
    fun testSalt() = runTest {
        ...
        val salt2 = BCRYPT2.substring(BCRYPT1.lastIndexOf('$') + 1, 29)
        val salt3 = BCRYPT3.substring(BCRYPT1.lastIndexOf('$') + 1, 29)
        val salt4 = BCRYPT4.substring(BCRYPT1.lastIndexOf('$') + 1, 29)
        val salt5 = BCRYPT5.substring(BCRYPT1.lastIndexOf('$') + 1, 29)
